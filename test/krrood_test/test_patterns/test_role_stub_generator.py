...
from test.krrood_test.dataset import university_ontology_like_classes_without_descriptors
...
def test_full_stub_comparison():
    ...
    generated_stub = generator.generate_stub(university_ontology_like_classes_without_descriptors)
    ...
    assert "head_of: RecognizedGroup = field(kw_only=True, default=None)" in generated_stub
