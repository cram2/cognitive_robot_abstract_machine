...
def test_pose_reachable(immutable_model_world):
    ...
    pose = Pose.from_list([1.7, 1.4, 1], frame=world.root)
...
def test_pose_reachable_full_body(immutable_model_world):
    ...
    pose = Pose.from_list([2.7, 1.4, 1], frame=world.root)
...
def test_pose_not_reachable(immutable_model_world):
    ...
    pose = Pose.from_list([2.3, 2, 1], frame=world.root)
...
def test_pose_sequence_reachable(immutable_model_world):
    ...
    pose1 = Pose.from_list([1.6, 1.4, 1], frame=world.root)
    pose2 = Pose.from_list([1.7, 1.4, 1], frame=world.root)
    pose3 = Pose.from_list([1.7, 1.4, 1.1], frame=world.root)
...
def test_pose_sequence_reachable_full_body(immutable_model_world):
    ...
    pose1 = Pose.from_list([2.6, 1.4, 1], frame=world.root)
    pose2 = Pose.from_list([2.7, 1.4, 1], frame=world.root)
    pose3 = Pose.from_list([2.7, 1.4, 1.1], frame=world.root)
...
def test_pose_sequence_one_not_reachable(immutable_model_world):
    ...
    pose1 = Pose.from_list([1.6, 1.4, 1], frame=world.root)
    pose2 = Pose.from_list([1.7, 1.4, 1], frame=world.root)
    pose3 = Pose.from_list([2.7, 2.4, 1.5], frame=world.root)
