    ...
    def test_running_in_10s_with_viewer(self):
        ...
        while simulator.state != SimulatorState.STOPPED:
            ...
            if use_write_data:
                ...
                write_objects["actuator1"]["cmd_joint_angular_position"].values[0][
                    0
                ] = act_1_value
                write_objects["actuator2"]["cmd_joint_angular_position"].values[0][
                    0
                ] = act_2_value
            ...
            if simulator.current_simulation_time > 1.0:
                ...
                self.assertAlmostEqual(
                    viewer.read_objects["joint2"]["joint_angular_position"].values[0][
                        0
                    ],
                    act_2_value,
                    places=0,
    ...
    def test_read_and_write_data_in_the_loop(self):
        ...
        for step in range(10000):
            ...
            if step == 100:
                ...
                self.assertEqual(
                    viewer.write_objects["box"]["position"].values[0][0], 1.1
                )
                self.assertEqual(
                    viewer.write_objects["box"]["position"].values[0][1], 2.2
                )
                self.assertEqual(
                    viewer.write_objects["box"]["position"].values[0][2], 3.3
                )
                self.assertEqual(
                    viewer.write_objects["box"]["quaternion"].values[0][0], 0.707
                )
                self.assertEqual(
                    viewer.write_objects["box"]["quaternion"].values[0][1], 0.0
                )
                self.assertEqual(
                    viewer.write_objects["box"]["quaternion"].values[0][2], 0.707
                )
                self.assertEqual(
                    viewer.write_objects["box"]["quaternion"].values[0][3], 0.0
                )
                ...
                self.assertEqual(
                    viewer.read_objects["box"]["position"].values[0][0], 1.1
                )
                self.assertEqual(
                    viewer.read_objects["box"]["position"].values[0][1], 2.2
                )
                self.assertAlmostEqual(
                    viewer.read_objects["box"]["position"].values[0][2], 3.3, places=3
                )
                self.assertAlmostEqual(
                    viewer.read_objects["box"]["quaternion"].values[0][0],
                    0.7071067811865475,
                )
                self.assertAlmostEqual(
                    viewer.read_objects["box"]["quaternion"].values[0][1], 0.0
                )
                self.assertAlmostEqual(
                    viewer.read_objects["box"]["quaternion"].values[0][2],
                    0.7071067811865475,
                )
                self.assertAlmostEqual(
                    viewer.read_objects["box"]["quaternion"].values[0][3], 0.0
                )
            else:
