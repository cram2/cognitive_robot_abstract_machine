"""
Tests for basstler.plan_item_mode, which resolves how a plan-item skill starts an item.
...
import basstler.plan_item_mode
from basstler.plan_item_mode import (
    CommandLineOption,
    ExecutionMode,
    ExitCode,
    Location,
...
MODE_MODULE = basstler.plan_item_mode.__name__
"""
...
def test_each_refusal_carries_its_own_exit_code():
    codes = {
        ...
        basstler.plan_item_mode.SettingsWriteRefusedError: ExitCode.SETTINGS_WRITE_REFUSED,
    }
