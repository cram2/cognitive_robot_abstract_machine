...
Usage:
    python3 -m basstler.plan_item_mode resolve --skill <kickoff|resolve> [--requested <mode>]
    python3 -m basstler.plan_item_mode set --skill <kickoff|resolve> [--skill ...] --mode <mode>
