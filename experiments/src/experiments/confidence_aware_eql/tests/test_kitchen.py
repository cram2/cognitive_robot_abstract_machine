...
def kitchen_clusters():
    ...
    return [
        FamiliarCluster(
            underspecified(KitchenObject)(weight=..., size=..., material=Material.CERAMIC),
            [
        ...
        FamiliarCluster(
            underspecified(KitchenObject)(weight=..., size=..., material=Material.GLASS),
            [
        ...
        FamiliarCluster(
            underspecified(KitchenObject)(weight=..., size=..., material=Material.METAL),
            [
