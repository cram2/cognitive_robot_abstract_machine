...
class TaskType(Enum):
    """
    Kind of manipulation task a :class:`TaskRequest` asks for.
    """
...
class Effect:
    ...
    Provides both the goal value and a way to read the current value, enabling BMP
    predicates to check whether a motion achieved its intent.
    """
...
class TaskRequest:
    ...
    task_type: TaskType
    """
    Kind of manipulation task being requested.
    """
