    ...
    def setup_default_configuration_in_world_below_robot_root(
        ...
        finger = cls(
            root=world.get_body_in_branch_by_name(
                robot_root, "robotiq_85_left_inner_knuckle_link"
            ),
...
@dataclass(eq=False)
class UR5RightFinger(UR5Finger):
    ...
    def setup_default_configuration_in_world_below_robot_root(
        ...
        finger = cls(
            root=world.get_body_in_branch_by_name(
                robot_root, "robotiq_85_right_inner_knuckle_link"
            ),
            tip=world.get_body_in_branch_by_name(
...
@dataclass(eq=False)
class UR5Gripper(ParallelGripper, ABC):
    ...
    def setup_default_configuration_in_world_below_robot_root(
        ...
        world = robot_root._world
        gripper = cls(
            root=world.get_body_in_branch_by_name(robot_root, "robotiq_85_base_link"),
    ...
    def setup_finger_semantic_annotations(self):
        thumb = UR5LeftFinger.setup_default_configuration_in_world_below_robot_root(
            self.root
        )
        self.add_thumb(thumb)
        finger = UR5RightFinger.setup_default_configuration_in_world_below_robot_root(
            self.root
        )
...
@dataclass(eq=False)
class UR5Arm(Arm, HasParallelGripper):
    ...
    def setup_end_effector_semantic_annotation(self):
        gripper = UR5Gripper.setup_default_configuration_in_world_below_robot_root(
            self.root
        )
...
class UR5(AbstractRobot, HasOneArm):
    ...
    def setup_arm_semantic_annotations(self):
        arm = UR5Arm.setup_default_configuration_in_world_below_robot_root(self.root)
        self.add_arm(arm)
