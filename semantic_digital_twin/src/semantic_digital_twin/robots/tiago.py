...
@dataclass(eq=False)
class Tiago(AbstractRobot, HasLeftRightArm, HasTorso, HasMobileBase):
    """
    ...
    def _setup_arm_semantic_annotations(self):
        ...
        left_gripper_thumb = Finger.create_and_add_to_world(
            ...
            tip_name="gripper_left_left_inner_finger_pad",
            world=self._world,
        )
        ...
        left_gripper_finger = Finger.create_and_add_to_world(
            ...
            root_name="gripper_left_base_link",
            tip_name="gripper_left_right_inner_finger_pad",
            world=self._world,
        )
    ...
    def _setup_torso_semantic_annotations(self):
        camera = Camera.create_and_add_to_world(
            ...
            root_name="head_front_camera_optical_frame",
...
@dataclass(eq=False)
class TiagoMujoco(AbstractRobot, HasLeftRightArm, HasTorso, HasMobileBase):
    """
    ...
    def _setup_arm_semantic_annotations(self):
        ...
        left_gripper_thumb = Finger.create_and_add_to_world(
            ...
            tip_name="gripper_left_left_finger_link",
            world=self._world,
        )
        ...
        left_gripper_finger = Finger.create_and_add_to_world(
            name=PrefixedName("left_gripper_finger", prefix=self.name.name),
            root_name="arm_left_7_link",
            tip_name="gripper_left_right_finger_link",
            world=self._world,
        )
        ...
        right_gripper_thumb = Finger.create_and_add_to_world(
            ...
            tip_name="gripper_right_left_finger_link",
            world=self._world,
        )
        right_gripper_finger = Finger.create_and_add_to_world(
            name=PrefixedName("right_gripper_finger", prefix=self.name.name),
            root_name="arm_right_7_link",
            tip_name="gripper_right_right_finger_link",
            world=self._world,
        )
        right_gripper = ParallelGripper.create_and_add_to_world(
            name=PrefixedName("right_gripper", prefix=self.name.name),
