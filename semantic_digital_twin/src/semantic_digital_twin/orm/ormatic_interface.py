...
import semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations
...
class Sage10kArtDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kArt
    ],
):

    __tablename__ = "Sage10kArtDAO"

    database_id: Mapped[builtins.int] = mapped_column(
        ForeignKey(Sage10kLabelDAO.database_id),
        primary_key=True,
        use_existing_column=True,
    )

    __mapper_args__ = {
        "polymorphic_identity": "Sage10kArtDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kPrintDAO(
    Sage10kArtDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kPrint
    ],
):

    __tablename__ = "Sage10kPrintDAO"

    database_id: Mapped[builtins.int] = mapped_column(
        ForeignKey(Sage10kArtDAO.database_id),
        primary_key=True,
        use_existing_column=True,
    )

    __mapper_args__ = {
        "polymorphic_identity": "Sage10kPrintDAO",
        "inherit_condition": database_id == Sage10kArtDAO.database_id,
    }


class Sage10kSculptureDAO(
    Sage10kArtDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kSculpture
    ],
):

    __tablename__ = "Sage10kSculptureDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kSculptureDAO",
        "inherit_condition": database_id == Sage10kArtDAO.database_id,
    }


class Sage10kArtworkDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kArtwork
    ],
):

    __tablename__ = "Sage10kArtworkDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kArtworkDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kBarrelDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kBarrel
    ],
):

    __tablename__ = "Sage10kBarrelDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kBarrelDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kBasketDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kBasket
    ],
):

    __tablename__ = "Sage10kBasketDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kBasketDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }
...
class Sage10kBinDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kBin
    ],
):

    __tablename__ = "Sage10kBinDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kBinDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kBookDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kBook
    ],
):

    __tablename__ = "Sage10kBookDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kBookDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kNotebookDAO(
    Sage10kBookDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kNotebook
    ],
):

    __tablename__ = "Sage10kNotebookDAO"

    database_id: Mapped[builtins.int] = mapped_column(
        ForeignKey(Sage10kBookDAO.database_id),
        primary_key=True,
        use_existing_column=True,
    )

    __mapper_args__ = {
        "polymorphic_identity": "Sage10kNotebookDAO",
        "inherit_condition": database_id == Sage10kBookDAO.database_id,
    }


class Sage10kCabinetDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kCabinet
    ],
):

    __tablename__ = "Sage10kCabinetDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kCabinetDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kChandelierDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kChandelier
    ],
):

    __tablename__ = "Sage10kChandelierDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kChandelierDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kChestDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kChest
    ],
):

    __tablename__ = "Sage10kChestDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kChestDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kClockDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kClock
    ],
):

    __tablename__ = "Sage10kClockDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kClockDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kCoasterDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kCoaster
    ],
):

    __tablename__ = "Sage10kCoasterDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kCoasterDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kCrateDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kCrate
    ],
):

    __tablename__ = "Sage10kCrateDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kCrateDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }
...
class Sage10kCupDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kCup
    ],
):

    __tablename__ = "Sage10kCupDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kCupDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kCushionDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kCushion
    ],
):

    __tablename__ = "Sage10kCushionDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kCushionDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kDecorDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kDecor
    ],
):

    __tablename__ = "Sage10kDecorDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kDecorDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kDecorativeDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kDecorative
    ],
):

    __tablename__ = "Sage10kDecorativeDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kDecorativeDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kDishwasherDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kDishwasher
    ],
):

    __tablename__ = "Sage10kDishwasherDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kDishwasherDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kDisplayDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kDisplay
    ],
):

    __tablename__ = "Sage10kDisplayDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kDisplayDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kMonitorDAO(
    Sage10kDisplayDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kMonitor
    ],
):

    __tablename__ = "Sage10kMonitorDAO"

    database_id: Mapped[builtins.int] = mapped_column(
        ForeignKey(Sage10kDisplayDAO.database_id),
        primary_key=True,
        use_existing_column=True,
    )

    __mapper_args__ = {
        "polymorphic_identity": "Sage10kMonitorDAO",
        "inherit_condition": database_id == Sage10kDisplayDAO.database_id,
    }


class Sage10kExtinguisherDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kExtinguisher
    ],
):

    __tablename__ = "Sage10kExtinguisherDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kExtinguisherDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kForkliftDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kForklift
    ],
):

    __tablename__ = "Sage10kForkliftDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kForkliftDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kFridgeDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kFridge
    ],
):

    __tablename__ = "Sage10kFridgeDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kFridgeDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kHammerDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kHammer
    ],
):

    __tablename__ = "Sage10kHammerDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kHammerDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kIslandDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kIsland
    ],
):

    __tablename__ = "Sage10kIslandDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kIslandDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }
...
class Sage10kKeyDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kKey
    ],
):

    __tablename__ = "Sage10kKeyDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kKeyDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kKeyboardDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kKeyboard
    ],
):

    __tablename__ = "Sage10kKeyboardDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kKeyboardDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kLadderDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kLadder
    ],
):

    __tablename__ = "Sage10kLadderDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kLadderDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kLampDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kLamp
    ],
):

    __tablename__ = "Sage10kLampDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kLampDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kCandleDAO(
    Sage10kLampDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kCandle
    ],
):

    __tablename__ = "Sage10kCandleDAO"

    database_id: Mapped[builtins.int] = mapped_column(
        ForeignKey(Sage10kLampDAO.database_id),
        primary_key=True,
        use_existing_column=True,
    )

    __mapper_args__ = {
        "polymorphic_identity": "Sage10kCandleDAO",
        "inherit_condition": database_id == Sage10kLampDAO.database_id,
    }


class Sage10kLanternDAO(
    Sage10kLampDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kLantern
    ],
):

    __tablename__ = "Sage10kLanternDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kLanternDAO",
        "inherit_condition": database_id == Sage10kLampDAO.database_id,
    }


class Sage10kLightingDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kLighting
    ],
):

    __tablename__ = "Sage10kLightingDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kLightingDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kMagazineDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kMagazine
    ],
):

    __tablename__ = "Sage10kMagazineDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kMagazineDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kMirrorDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kMirror
    ],
):

    __tablename__ = "Sage10kMirrorDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kMirrorDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kMouseDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kMouse
    ],
):

    __tablename__ = "Sage10kMouseDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kMouseDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }
...
class Sage10kMugDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kMug
    ],
):

    __tablename__ = "Sage10kMugDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kMugDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kOrganizerDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kOrganizer
    ],
):

    __tablename__ = "Sage10kOrganizerDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kOrganizerDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kOvenDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kOven
    ],
):

    __tablename__ = "Sage10kOvenDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kOvenDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kPalletDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kPallet
    ],
):

    __tablename__ = "Sage10kPalletDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kPalletDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }
...
class Sage10kPenDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kPen
    ],
):

    __tablename__ = "Sage10kPenDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kPenDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kPlantDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kPlant
    ],
):

    __tablename__ = "Sage10kPlantDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kPlantDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kRampDAO(
    Sage10kPlantDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kRamp
    ],
):

    __tablename__ = "Sage10kRampDAO"

    database_id: Mapped[builtins.int] = mapped_column(
        ForeignKey(Sage10kPlantDAO.database_id),
        primary_key=True,
        use_existing_column=True,
    )

    __mapper_args__ = {
        "polymorphic_identity": "Sage10kRampDAO",
        "inherit_condition": database_id == Sage10kPlantDAO.database_id,
    }


class Sage10kSucculentDAO(
    Sage10kPlantDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kSucculent
    ],
):

    __tablename__ = "Sage10kSucculentDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kSucculentDAO",
        "inherit_condition": database_id == Sage10kPlantDAO.database_id,
    }


class Sage10kPlateDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kPlate
    ],
):

    __tablename__ = "Sage10kPlateDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kPlateDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kShoeDAO(
    Sage10kPlateDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kShoe
    ],
):

    __tablename__ = "Sage10kShoeDAO"

    database_id: Mapped[builtins.int] = mapped_column(
        ForeignKey(Sage10kPlateDAO.database_id),
        primary_key=True,
        use_existing_column=True,
    )

    __mapper_args__ = {
        "polymorphic_identity": "Sage10kShoeDAO",
        "inherit_condition": database_id == Sage10kPlateDAO.database_id,
    }


class Sage10kPliersDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kPliers
    ],
):

    __tablename__ = "Sage10kPliersDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kPliersDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kPrinterDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kPrinter
    ],
):

    __tablename__ = "Sage10kPrinterDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kPrinterDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kRackDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kRack
    ],
):

    __tablename__ = "Sage10kRackDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kRackDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kRemoteDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kRemote
    ],
):

    __tablename__ = "Sage10kRemoteDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kRemoteDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }
...
class Sage10kSawDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kSaw
    ],
):

    __tablename__ = "Sage10kSawDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kSawDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kScrewdriverDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kScrewdriver
    ],
):

    __tablename__ = "Sage10kScrewdriverDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kScrewdriverDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kScrollDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kScroll
    ],
):

    __tablename__ = "Sage10kScrollDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kScrollDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kSeatDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kSeat
    ],
):

    __tablename__ = "Sage10kSeatDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kSeatDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kChairDAO(
    Sage10kSeatDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kChair
    ],
):

    __tablename__ = "Sage10kChairDAO"

    database_id: Mapped[builtins.int] = mapped_column(
        ForeignKey(Sage10kSeatDAO.database_id),
        primary_key=True,
        use_existing_column=True,
    )

    __mapper_args__ = {
        "polymorphic_identity": "Sage10kChairDAO",
        "inherit_condition": database_id == Sage10kSeatDAO.database_id,
    }


class Sage10kArmchairDAO(
    Sage10kChairDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kArmchair
    ],
):

    __tablename__ = "Sage10kArmchairDAO"

    database_id: Mapped[builtins.int] = mapped_column(
        ForeignKey(Sage10kChairDAO.database_id),
        primary_key=True,
        use_existing_column=True,
    )

    __mapper_args__ = {
        "polymorphic_identity": "Sage10kArmchairDAO",
        "inherit_condition": database_id == Sage10kChairDAO.database_id,
    }


class Sage10kPoufDAO(
    Sage10kSeatDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kPouf
    ],
):

    __tablename__ = "Sage10kPoufDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kPoufDAO",
        "inherit_condition": database_id == Sage10kSeatDAO.database_id,
    }


class Sage10kSofaDAO(
    Sage10kSeatDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kSofa
    ],
):

    __tablename__ = "Sage10kSofaDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kSofaDAO",
        "inherit_condition": database_id == Sage10kSeatDAO.database_id,
    }


class Sage10kStoolDAO(
    Sage10kSeatDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kStool
    ],
):

    __tablename__ = "Sage10kStoolDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kStoolDAO",
        "inherit_condition": database_id == Sage10kSeatDAO.database_id,
    }


class Sage10kShelfDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kShelf
    ],
):

    __tablename__ = "Sage10kShelfDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kShelfDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kBookshelfDAO(
    Sage10kShelfDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kBookshelf
    ],
):

    __tablename__ = "Sage10kBookshelfDAO"

    database_id: Mapped[builtins.int] = mapped_column(
        ForeignKey(Sage10kShelfDAO.database_id),
        primary_key=True,
        use_existing_column=True,
    )

    __mapper_args__ = {
        "polymorphic_identity": "Sage10kBookshelfDAO",
        "inherit_condition": database_id == Sage10kShelfDAO.database_id,
    }


class Sage10kSideboardDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kSideboard
    ],
):

    __tablename__ = "Sage10kSideboardDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kSideboardDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kSignDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kSign
    ],
):

    __tablename__ = "Sage10kSignDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kSignDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kSinkDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kSink
    ],
):

    __tablename__ = "Sage10kSinkDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kSinkDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kSpeakerDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kSpeaker
    ],
):

    __tablename__ = "Sage10kSpeakerDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kSpeakerDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kStoveDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kStove
    ],
):

    __tablename__ = "Sage10kStoveDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kStoveDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kTableDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kTable
    ],
):

    __tablename__ = "Sage10kTableDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kTableDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kBenchDAO(
    Sage10kSeatDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kBench
    ],
):

    __tablename__ = "Sage10kBenchDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kBenchDAO",
        "inherit_condition": database_id == Sage10kSeatDAO.database_id,
    }


class Sage10kCounterDAO(
    Sage10kTableDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kCounter
    ],
):

    __tablename__ = "Sage10kCounterDAO"

    database_id: Mapped[builtins.int] = mapped_column(
        ForeignKey(Sage10kTableDAO.database_id),
        primary_key=True,
        use_existing_column=True,
    )

    __mapper_args__ = {
        "polymorphic_identity": "Sage10kCounterDAO",
        "inherit_condition": database_id == Sage10kTableDAO.database_id,
    }


class Sage10kDeskDAO(
    Sage10kTableDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kDesk
    ],
):

    __tablename__ = "Sage10kDeskDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kDeskDAO",
        "inherit_condition": database_id == Sage10kTableDAO.database_id,
    }


class Sage10kStandDAO(
    Sage10kTableDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kStand
    ],
):

    __tablename__ = "Sage10kStandDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kStandDAO",
        "inherit_condition": database_id == Sage10kTableDAO.database_id,
    }


class Sage10kWorkbenchDAO(
    Sage10kTableDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kWorkbench
    ],
):

    __tablename__ = "Sage10kWorkbenchDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kWorkbenchDAO",
        "inherit_condition": database_id == Sage10kTableDAO.database_id,
    }


class Sage10kVaseDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kVase
    ],
):

    __tablename__ = "Sage10kVaseDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kVaseDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }


class Sage10kWrenchDAO(
    Sage10kLabelDAO,
    DataAccessObject[
        semantic_digital_twin.adapters.sage_10k_dataset.generated_semantic_annotations.Sage10kWrench
    ],
):

    __tablename__ = "Sage10kWrenchDAO"
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Sage10kWrenchDAO",
        "inherit_condition": database_id == Sage10kLabelDAO.database_id,
    }
